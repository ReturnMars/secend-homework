...
export default function BatchDetail() {
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            name: "", phone: "", date: "", province: "", city: "", district: "", reason: "",
        },
    });
    ...
    if (!batch) return <div className="p-10 text-center text-muted-foreground animate-pulse">Loading batch data...</div>;
